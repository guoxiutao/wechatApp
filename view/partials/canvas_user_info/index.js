...
Component({
  ...
  ready:function(){
    ...
    this.getUserInfo();
    console.log('ewmImgUrl',this.data.ewmImgUrl)
  ...
  methods: {
    ...
    customMethod: function () {
      ...
      context.fillText("长按识别小程序码访问【" + that.data.platformName + '】', clientWidth*0.37, clientWidth-8 )
      context.stroke()
      // that.circleImg(context, that.data.img_l, clientWidth * 0.18, 10, 16);
